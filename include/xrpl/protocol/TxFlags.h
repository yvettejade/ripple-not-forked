...
// Indicating specific flags may never be changed after issuance.
inline constexpr FlagValue tifMPTCanHoldConfidentialBalance = lsifMPTCanHoldConfidentialBalance;
inline constexpr FlagValue tifMPTokenIssuanceCreateImmutableMask = ~tifMPTCanHoldConfidentialBalance;
